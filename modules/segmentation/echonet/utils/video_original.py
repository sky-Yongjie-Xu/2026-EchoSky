    ...
    with open(os.path.join(output, "log.csv"), "a") as f:
        ...
        for epoch in range(epoch_resume, num_epochs):
            ...
            for phase in ['train', 'val']:
                ...
                loss, yhat, y = echonet.utils.video_original.run_epoch(model, dataloader, phase == "train", optim, device)
                f.write("{},{},{},{},{},{},{},{},{}\n".format(epoch,
                                                              phase,
                                                              loss,
        ...
        if run_test:
            for split in ["val", "test"]:
                ...
                loss, yhat, y = echonet.utils.video_original.run_epoch(model, dataloader, False, None, device)
                ...
                loss, yhat, y = echonet.utils.video_original.run_epoch(model, dataloader, False, None, device, save_all=True, block_size=batch_size)
