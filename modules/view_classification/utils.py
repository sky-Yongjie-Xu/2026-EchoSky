################ 
# The following functions are view classification related functions
################
import re
import json
import numpy as np
...
def initialize_language(lang='en'):
    ...
    if lang == 'en':
        ...
        phrases_file = "assets/all_phr_zh.json"
...
################ 
# The following functions are high throughput approach for detecting chronic liver disease using echocardiography
################
